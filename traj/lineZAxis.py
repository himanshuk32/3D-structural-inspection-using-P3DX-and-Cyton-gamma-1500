...
manipPose2 = [0.3, -0.1, 0.55, 3.55992334659e-05, 2.53591989399e-05, 0.707060385227, 0.707153172752]
...
while not rospy.is_shutdown():
	...
	#velPub.publish(Twist(Vector3(0.5, 0, 0), Vector3(0, 0, 0.5)))
	print "robot base should start"
